...
@section('content')
{{ Form::open(['action' => ['CommentController@updateappointment',$calendar->id], 'method' => 'POST', 'enctype' => 'multipart/form-data'])}}
        
{{Form::label('event_name', 'Enter Appointment Title')}}
{{Form::text('event_name', $calendar->event_name, ['class' => 'form-control', 'placeholder' => 'Event Name'])}}
